...
export default class Question extends Component {
  ...
  renderSearchForm() {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline" className="search">
        <div className="kuai">
          <span className="span">问题关键字 :</span>
          <FormItem className="inputW160">
            {getFieldDecorator('title')(<Input placeholder="请输入问题关键字" />)}
          </FormItem>
        </div>
  ...
  render() {
    ...
    const columns = [
      { title: '分类问题', width: 150, dataIndex: 'typename', key: 'typename' },
      { title: '题号', width: 120, dataIndex: 'question_no', key: 'question_no' },
      ...
      { title: '操作',
        ...
        render: (text, record) => (
          <Fragment>
            ...
            <a onClick={() => { this.editAnswerDrawer(record) }}>编辑答案</a> */}
            <Divider type="vertical" />

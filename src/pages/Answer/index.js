...
export default class Item extends Component {
  ...
  render() {
    ...
    const columns = [
      { title: '特征编号', width: 120, dataIndex: 'skuTagId', key: 'skuTagId' },
      { title: '特征名称', dataIndex: 'skuTagName', key: 'skuTagName' },
      { title: '操作',
        key: 'operation',
        width: 100,
        fixed: 'right',
    ...
    return (
      <div>
        ...
        <Card key={'b'}
          ...
          title={<span className={styles.tableTitle}><Icon type="appstore-o" /> 特征列表
